...
void elimlog(char s[], bool &errorx)
{
...
void elimrad(char s[], bool &errorx)
{
...
long double calcul(int a,int b,long double x,char s[],bool &errorx)
{
...
long double solve(long double x,char s[],bool &errorx)
{
    int poz,i;
    char aux[201],t[201];
    bool gasit=1;
